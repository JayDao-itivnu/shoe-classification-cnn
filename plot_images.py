...
def plot_images(images, cls_true, cls_pred=None):
    ...
    x_axis = math.ceil(math.sqrt(len(images)));
    y_axis = math.ceil(len(images)/x_axis);
...
def plot_example_errors(cls_pred,image,y_true):
    ...
    #print(len(images))
    print("CLS_PREDICT = ",cls_pred)
    print("CLS_TRUE = ", cls_true)

    # Plot the first 9 images.
    plot_images(images=images[0:6],
                cls_true=cls_true[0:6],
                cls_pred=cls_pred[0:6]
                )
